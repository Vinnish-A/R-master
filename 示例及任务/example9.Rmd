...
```{r echo=FALSE, out.width="80%", fig.align='center', fig.cap="Rmarkdown由三部分组成：Yaml头、可随处插入的代码块、文本"}
...
```{r echo=FALSE, out.width="80%", fig.align='center', fig.cap="bib文件就是被整理规范的引用信息"}
knitr::include_graphics("./pic/reference.png")
```
...
```{r echo=FALSE, out.width="80%", fig.align='center', fig.cap="导出即可"}
knitr::include_graphics("./pic/zotero.png")
```
...
```{r echo=FALSE, out.width="80%", fig.align='center', fig.cap="点击source字样"}
knitr::include_graphics("./pic/ncb.png")
```
...
```{r echo=FALSE, out.width="80%", fig.align='center', fig.cap="点击source字样"}
knitr::include_graphics("./pic/citr.png")
```
